<section class="catalog-card"><div class="flex-between item-center header-catalog-card"><h1 class="catalog-head">жіночий одяг</h1><div class="filter-btn-mobile"> <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="11" height="10" viewBox="0 0 11 10" fill="none">
