<section class="about-us-block active-help help-content" id="aboutUs"><div class="description-about-us"><h2>Про нас</h2><p>Дешевше – це роздрібний інтернет-магазин. Ми пропонуємо нашим клієнтам унікальну лінійку товарів – одяг, взуття, білизна, аксесуари, сумки, рюкзаки, товари для дому та кухні, текстиль від українських та закордонних виробників. Менеджери Дешевше на українських та турецьких складах контролюють процес упаковки і якості товару перед відправкою, спілкуються із постачальниками напряму та домовляються про найвигіднішу ціну. </p><p class="flag-order flag-help">Наша головна мета – низькі ціни на якісні товари.</p></div><section class="top-prodaz"><h2>топ продажів</h2><div class="wrapper-card"><div class="top-prodaz-card"><figure class="card"><a href="card.html"></a><figcaption> <div class="card-view-block item-center"><div class="main-info-card item-center"><div class="image-block-card"><span class="flag"> <span>new</span></span><picture><img src="img/catalog-card.png" alt=""/></picture></div><form action="#"><div class="haracteristic-block-card"><div class="hover-card"><h3>Шорти джинсові жіночі, колір блакитний</h3><div class="color d-flex item-center"><label><input type="radio" name="color" value="black" required="required"/></label><label><input type="radio" name="color" value="red" disabled="disabled" required="required"/></label><label><input type="radio" name="color" value="blue" required="required"/></label><label><input type="radio" name="color" value="gray" disabled="disabled" required="required"/></label><label><input type="radio" name="color" value="white" required="required"/></label></div><p class="article">Артикул: 83635337</p><div class="size d-flex item-center"><p><input type="radio" name="size" id="xs" required="required"/><label for="xs">xs</label></p><p><input type="radio" name="size" id="s" required="required"/><label for="s">s</label></p><p><input type="radio" name="size" id="m" required="required"/><label for="m">m</label></p><p><input type="radio" name="size" id="l" required="required"/><label for="l">l</label></p><p><input type="radio" name="size" id="xl" required="required"/><label for="xl">xl</label></p><p><input type="radio" name="size" id="xxl" required="required"/><label for="xxl">xxl</label></p></div><p class="d-flex price-block item-center"><span class="price">800₴</span><span class="old-price">1200₴</span></p></div></div></form></div><div class="btn-view-block d-flex"><button class="blue-btn submit-btn orderCtaCard" type="submit">купити </button><button class="oneClickBtn" type="submit" title="Купити в 1 клік"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 17 17" style="enable-background:new 0 0 15 15;" xml:space="preserve">
<g>
<g>
...
</svg></button></div></div></figcaption></figure><figure class="card"><a href="card.html"></a><figcaption> <div class="card-view-block item-center"><div class="main-info-card item-center"><div class="image-block-card"><span class="flag"> <span>new</span></span><picture><img src="img/catalog-card.png" alt=""/></picture></div><form action="#"><div class="haracteristic-block-card"><div class="hover-card"><h3>Шорти джинсові жіночі, колір блакитний</h3><div class="color d-flex item-center"><label><input type="radio" name="color" value="black" required="required"/></label><label><input type="radio" name="color" value="red" disabled="disabled" required="required"/></label><label><input type="radio" name="color" value="blue" required="required"/></label><label><input type="radio" name="color" value="gray" disabled="disabled" required="required"/></label><label><input type="radio" name="color" value="white" required="required"/></label></div><p class="article">Артикул: 83635337</p><div class="size d-flex item-center"><p><input type="radio" name="size" id="xs" required="required"/><label for="xs">xs</label></p><p><input type="radio" name="size" id="s" required="required"/><label for="s">s</label></p><p><input type="radio" name="size" id="m" required="required"/><label for="m">m</label></p><p><input type="radio" name="size" id="l" required="required"/><label for="l">l</label></p><p><input type="radio" name="size" id="xl" required="required"/><label for="xl">xl</label></p><p><input type="radio" name="size" id="xxl" required="required"/><label for="xxl">xxl</label></p></div><p class="d-flex price-block item-center"><span class="price">800₴</span><span class="old-price">1200₴</span></p></div></div></form></div><div class="btn-view-block d-flex"><button class="blue-btn submit-btn orderCtaCard" type="submit">купити </button><button class="oneClickBtn" type="submit" title="Купити в 1 клік"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 17 17" style="enable-background:new 0 0 15 15;" xml:space="preserve">
<g>
<g>
<path class="st0" d="M6.9,0.5c-0.1-0.1-0.2-0.1-0.4,0c-0.1,0-0.1,0.1-0.2,0.1H7C7,0.5,7,0.5,6.9,0.5z"/>
<path class="st0" d="M7.2,1.3l-1.6,5C5.5,6.5,5.3,6.7,5.1,6.7c-0.1,0-0.1,0-0.2,0l-0.1,0v0C4.6,6.5,4.5,6.1,4.6,5.8l1.6-5 c0-0.1,0.1-0.2,0.2-0.3H7C7.2,0.7,7.3,1,7.2,1.3z"/>
...
</svg></button></div></div></figcaption></figure></div></div></section><div class="catalog-cta-center"><a class="yellow-cta" href="catalog.pug">в каталог</a></div></section>